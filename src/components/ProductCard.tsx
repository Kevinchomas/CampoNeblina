      ...
      <View style={styles.cardBody}>
        <View style={styles.headerRow}>
          <View
            style={[
              styles.badge,
              isServicio ? styles.badgeServicio : styles.badgeProducto,
            ]}
          >
            <Text
              style={[
                styles.badgeText,
                isServicio
                  ? styles.badgeTextServicio
                  : styles.badgeTextProducto,
              ]}
            >
        ...
        <View style={styles.vendedorRow}>
          ...
          <View style={styles.inmuebleTag}>
            <Text style={styles.inmuebleTagText}>
              Torre {item.vendedorInmueble?.torre} - Apto{" "}
              {item.vendedorInmueble?.codigo}
            </Text>
          </View>
        </View>
        ...
        <SocialBar
          likes={item.likes}
          comentariosCount={
            item.comentarios?.length || (item as any).numComentarios || 0
          }
...
const styles = StyleSheet.create({
  ...
  badgeProducto: { backgroundColor: "#E5EAE2" },
  badgeServicio: { backgroundColor: "#FEF3C7" },
  badgeText: { fontSize: 11, fontWeight: "bold" },
  badgeTextProducto: { color: "#234919" },
  badgeTextServicio: { color: "#D97706" },
