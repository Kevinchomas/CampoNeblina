...
export const MarketplaceScreen: React.FC = () => {
  ...
  const handleConfirmReport = async () => {
    ...
    if (!motivoReporte.trim()) {
      Alert.alert(
        "Motivo Requerido",
        "Escribe una breve explicación de tu reporte.",
      );
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        "Reporte Enviado",
        "Gracias por colaborar. La Junta revisará la publicación.",
      );
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitle}>Compra y venta entre residentes</Text>
          </View>
      ...
      <View style={styles.filterRow}>
        {[
          ...
          <TouchableOpacity
            ...
            style={[
              styles.filterChip,
              categoryFilter === cat.value && styles.filterChipSelected,
            ]}
          ...
          >
            <Text
              style={[
                ...
                categoryFilter === cat.value && styles.filterChipTextSelected,
              ]}
            >
              {cat.label}
            </Text>
          ...
          ListEmptyComponent={
            <View style={styles.emptyBox}>
              ...
              <Text style={styles.emptySubtitle}>
                Sé el primero en ofrecer un producto o servicio.
              </Text>
            </View>
          }
        />
